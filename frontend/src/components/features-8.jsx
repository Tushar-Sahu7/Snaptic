            ...
            >
              <CardContent className="pt-6">
                ...
                <div className="relative z-10 mt-14 space-y-2 text-center">
                  ...
                  <p className="text-muted-foreground text-sm">
                    Mark attendance in less than 2 seconds per student. Scan an
                    entire class of 60+ students in under 2 minutes.
                  </p>
                </div>
              </CardContent>
            </MotionCard>
              ...
              <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-muted-foreground text-sm">
                      Watch your attendance list fill up in real-time during the
                      scan. Quickly see who is present and missing for every
                      single session.
                    </p>
                  </div>
                </div>
