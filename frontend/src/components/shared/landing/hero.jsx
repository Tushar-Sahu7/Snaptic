                            ...
                            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                                <AnimatedGroup variants={transitionVariants}>
                                    <Link
                                        ...
                                        <span className="text-foreground text-sm">AI based Attendance</span>
                                    ...
                                    <h1
                                        ...
                                        Modern Solutions for <span className="text-primary">Attendance Tracking</span>
                                    </h1>
                                    <p
                                        className="mx-auto mt-8 max-w-2xl text-balance text-lg text-muted-foreground">
                                        Experience the future of facial recognition attendance. Secure, fast, and highly customizable for any teachers.
                                    </p>
                                </AnimatedGroup>
                                ...
                                <AnimatedGroup
                                    ...
                                    <div
                                        ...
                                        <Button
                                            ...
                                            <Link to="/register">
                                                <span className="text-nowrap">Start Taking Attendance</span>
                                            </Link>
                                        </Button>
                                    </div>
                                    <Button
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50">
            <nav
                ...
                <div className={cn('mx-auto mt-4 max-w-6xl px-6 transition-all duration-300 lg:px-12 py-3', 
                    isScrolled ? 'bg-background/80 max-w-4xl rounded-2xl border backdrop-blur-xl lg:px-8' : 'bg-transparent')}>
