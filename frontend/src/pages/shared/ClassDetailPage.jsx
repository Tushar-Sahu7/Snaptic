...
export default function ClassDetailPage() {
  ...
  const handleToggleArchive = async () => {
    ...
    try {
      ...
      toast.success(
        `Class ${newStatus === "archived" ? "archived" : "unarchived"}`,
      );
    } catch (err) {
  ...
  if (error || !classData) {
    return (
      <div className="container mx-auto px-4 py-24 text-center space-y-6">
        ...
        <Button
          onClick={() =>
            navigate(isStudent ? "/student/classes" : "/teacher/classes")
          }
        >
          Back to Classes
        </Button>
          ...
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              ...
              {classData.status === "archived" && (
                <Badge
                  variant="secondary"
                  className="px-3 py-1 rounded-full text-[10px] font-bold uppercase tracking-widest bg-amber-500/10 text-amber-600 border-amber-500/20"
                >
                  Archived
                </Badge>
              )}
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-2 text-muted-foreground font-medium">
              ...
              <div className="flex items-center gap-2 text-sm">
                ...
                <span>
                  {formatDays(classData.schedule)} •{" "}
                  {formatClassTimeRange(classData)}
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  <div className="space-y-1.5">
                    ...
                    <p className="text-muted-foreground font-medium">
                      Search the directory or import students from other
                      classes.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 items-center">
                    ...
                    <Button
                      variant="secondary"
                      className="h-11 rounded-xl font-bold gap-2 px-6 shadow-sm w-full sm:w-auto"
                      ...
                      {searchResults.length > 0 ? (
                        <ClassStudentDataTable
                          ...
                          actionsRender={(student) => {
                            const alreadyIn = activeStudents.some(
                              (s) => s._id === student._id,
                            );
                            return alreadyIn ? (
                              <Badge
                                variant="outline"
                                className="bg-emerald-500/10 text-emerald-600 border-emerald-500/20 gap-1.5 px-3 py-1 rounded-lg font-bold"
                              >
                                <Check className="w-3.5 h-3.5" /> Already
                                Enrolled
                              </Badge>
                            ) : (
                              <Button
                              ...
                              >
                                ...
                                addStudentMutation.variables?.studentId ===
                                  student._id ? (
                                  <Spinner
                        ...
                        <div className="p-10 flex flex-col items-center justify-center text-center gap-6">
                          ...
                          <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground font-medium max-w-sm">
                              Would you like to enroll this student as a new
                              user using their email?
                            </p>
                          </div>
                          <Button
                ...
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <CardDescription className="text-base font-medium">
                      Currently enrolled students in this class.
                    </CardDescription>
                  </div>
                  <Badge
                    variant="secondary"
                    className="h-7 px-3 rounded-full font-bold bg-primary/10 text-primary border-primary/20"
                  >
                ...
                {activeStudents.length === 0 ? (
                  <div className="py-24 text-center space-y-6 animate-in fade-in zoom-in-95 duration-500">
                    ...
                    {!isStudent && (
                      <Button
                        variant="outline"
                        className="rounded-xl font-bold gap-2 px-8 h-11"
                  ...
                  <ClassStudentDataTable
                    ...
                    onRowClick={(student) => {
                      ...
                      navigate(
                        `/teacher/classes/${id}?student=${student._id}&tab=records`,
                      );
                    }}
                    toolbarActions={
                      !isStudent &&
                    ...
                    actionsRender={(student) => (
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent
                          align="end"
                          className="rounded-xl w-48 p-1.5"
                        >
                          {!isStudent && (
                            <DropdownMenuItem
                              onClick={() =>
                            ...
                            >
                              <CalendarDays className="mr-2 w-4 h-4 text-muted-foreground" />{" "}
                              View Records
                            </DropdownMenuItem>
                          )}
                          ...
                          {!isStudent && (
                            <>
                              ...
                              >
                                <Trash2 className="mr-2 w-4 h-4" /> Remove from
                                Class
                              </DropdownMenuItem>
                            </>
                          )}
            ...
            <div className="space-y-6">
                ...
                <div className="space-y-1">
                  <h2 className="text-2xl font-black flex items-center gap-2">
                    ...
                    {isStudent
                      ...
                      : `${activeLedgerRecord.name}'s Ledger`}
                  </h2>
                  <p className="text-muted-foreground font-medium">
                    {isStudent
                      ? "Your personal attendance record for this class."
                      : "Detailed student attendance record."}
                  </p>
                </div>
                {!isStudent && (
                  <Button
              ...
              <AttendanceLedger
                ...
                stats={{
                  ...
                  absentCount:
                    activeLedgerRecord.totalSessions -
                    activeLedgerRecord.presentCount,
              ...
              <CardHeader className="p-8 pb-4">
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    ...
                    <CardDescription className="text-base font-medium">
                      View and manage past attendance sessions.
                    </CardDescription>
                  </div>
                  <Badge
                    variant="secondary"
      ...
      {!isStudent && (
        <>
          ...
          <ClassDeleteDialog
            ...
            classData={classData}
            onDeleted={() => navigate("/teacher/classes")}
          />
