  ...
  return (
    <div
      ...
      className={cn(
        ...
        isFullscreen
          ? "fixed inset-0 z-100"
          : "aspect-video rounded-3xl border border-border/40 shadow-2xl",
      )}
    >
      <div
            ...
            >
              <Empty className="max-w-md border-none bg-transparent">
                <EmptyHeader>
                  ...
                  <EmptyTitle className="text-2xl font-bold text-white mb-1">
                    Ready to Scan?
                  </EmptyTitle>
                  <EmptyDescription className="text-zinc-400">
                    Point the camera towards students. The camera will
                    automatically recognize and mark attendance in real-time.
                  </EmptyDescription>
                </EmptyHeader>
                <EmptyContent>
                      ...
                      >
                        <div className="flex flex-col items-center">
                          ...
                          <div className="mt-1 px-4 py-2 rounded-2xl bg-white border border-zinc-200 shadow-2xl flex flex-col items-center">
                            <p className="text-[11px] font-black text-zinc-900 whitespace-nowrap uppercase tracking-wider">
                              {match.name}
                            </p>
